...
using InvoiceMenager.Models.Repository;
using InvoiceMenager.Models.ViewModels;
using Microsoft.AspNet.Identity;
using Microsoft.Owin.Security.Provider;
using System;
using System.Web.Mvc;

namespace InvoiceMenager.Controllers
{
    [Authorize]
    public class HomeController : Controller
    {
        ...
        public ActionResult InvoicePosition(int invoiceId,
